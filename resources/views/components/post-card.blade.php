...
<article class="group overflow-hidden rounded-2xl border border-black/10 bg-white shadow-soft transition duration-300 hover:-translate-y-1 hover:border-emerald-500 hover:shadow-glow">
