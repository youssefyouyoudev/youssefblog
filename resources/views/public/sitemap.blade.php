...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    @foreach ([route('home'), route('posts.index'), route('tools.index'), route('money.index'), route('services'), route('about'), route('author.youssef'), route('contact'), route('privacy'), route('terms'), route('editorial-policy'), route('affiliate-disclosure')] as $url)
